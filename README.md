...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-udapi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12907&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-udapi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-udapi` can be installed with:

```
conda install r-udapi
```

It is possible to list all of the versions of `r-udapi` available on your platform with:
